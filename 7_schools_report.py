...
schools = json.load(infile) # schools is a list once json file is loaded since it starts w a []
...
for school in schools: # school is a dictionary
    ...
    if school["NCAA"]["NAIA conference number football (IC2020)"] in conference_schools:
        ...
        if school["Total price for in-state students living off campus (not with family)  2020-21 (DRVIC2020)"]:
            if school["Total price for in-state students living off campus (not with family)  2020-21 (DRVIC2020)"] > 50000:
                print(f"University:", school["instnm"])
                print(f"Total price for in-state students living off campus (not with family):", school["Total price for in-state students living off campus (not with family)  2020-21 (DRVIC2020)"], "\n")